...
int mpu_read_fast_fifo(short *gyro, short *accel, unsigned long *timestamp,
                       unsigned char *sensors, unsigned char *more){
    unsigned char data[MAX_PACKET_LENGTH];
    //unsigned char packet_size = 12;
    ...
    gyro[0] = (data[6 + 0] << 8) | data[6 + 1];
    gyro[1] = (data[8 + 0] << 8) | data[8 + 1];
    gyro[2] = (data[10 + 0] << 8) | data[10 + 1];
