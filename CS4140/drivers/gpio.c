...
//motors
    NRF_GPIOTE->CONFIG[0] =
            GPIOTE_CONFIG_MODE_Msk | (MOTOR_0_PIN << GPIOTE_CONFIG_PSEL_Pos) | GPIOTE_CONFIG_POLARITY_Msk |
            GPIOTE_CONFIG_OUTINIT_Msk;
    NRF_GPIOTE->CONFIG[1] =
            GPIOTE_CONFIG_MODE_Msk | (MOTOR_1_PIN << GPIOTE_CONFIG_PSEL_Pos) | GPIOTE_CONFIG_POLARITY_Msk |
            GPIOTE_CONFIG_OUTINIT_Msk;
    NRF_GPIOTE->CONFIG[2] =
            GPIOTE_CONFIG_MODE_Msk | (MOTOR_2_PIN << GPIOTE_CONFIG_PSEL_Pos) | GPIOTE_CONFIG_POLARITY_Msk |
            GPIOTE_CONFIG_OUTINIT_Msk;
    NRF_GPIOTE->CONFIG[3] =
            GPIOTE_CONFIG_MODE_Msk | (MOTOR_3_PIN << GPIOTE_CONFIG_PSEL_Pos) | GPIOTE_CONFIG_POLARITY_Msk |
            GPIOTE_CONFIG_OUTINIT_Msk;
