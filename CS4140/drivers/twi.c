...
void twi_init(void) {
    nrf_gpio_cfg(TWI_SCL, NRF_GPIO_PIN_DIR_INPUT, NRF_GPIO_PIN_INPUT_CONNECT, NRF_GPIO_PIN_PULLUP, NRF_GPIO_PIN_S0D1,
                 NRF_GPIO_PIN_NOSENSE);
    nrf_gpio_cfg(TWI_SDA, NRF_GPIO_PIN_DIR_INPUT, NRF_GPIO_PIN_INPUT_CONNECT, NRF_GPIO_PIN_PULLUP, NRF_GPIO_PIN_S0D1,
                 NRF_GPIO_PIN_NOSENSE);
    ...
    NRF_TWI0->INTENSET = TWI_INTENSET_TXDSENT_Msk | TWI_INTENSET_RXDREADY_Msk |
                         TWI_INTENSET_ERROR_Msk;// | TWI_INTENSET_SUSPENDED_Msk | TWI_INTENSET_BB_Msk | TWI_INTENSET_STOPPED_Msk;
